...
# update path is:
#   devtools::install_github("jncohen/docdesigner-template")
#   docdesigner::docdesigner_use(overwrite = TRUE)
#
...
docdesigner_update <- function(
  ...
  base   <- paste0("https://raw.githubusercontent.com/jncohen/docdesigner-template/",
                   branch)
  ...
  message("Fetching docdesigner-template (", branch, ") to: ", dest)
