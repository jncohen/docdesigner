...
\else
  ...
  %% The package bundles the text and code fonts used by these presets. Matching
  %% math fonts are optional; unicode-math falls back to the engine default when
  ...
  \ifdocdesignerhumanities
    ...
    \IfFileExists{\docdesignerfontsdir Garamond-Math.otf}{%
      \setmathfont{Garamond-Math.otf}[Path=\docdesignerfontsdir]%
    }{%
      \IfFontExistsTF{Garamond Math}{%
        \setmathfont{Garamond Math}%
      }{%
        \IfFileExists{\docdesignerfontsdir XITSMath-Regular.otf}{%
  ...
  \else
    ...
    \IfFontExistsTF{TeX Gyre Pagella Math}{%
      ...
      \PackageWarning{docdesignertemplate}{TeX Gyre Pagella Math not found.
        Math will use the unicode-math default. Install tex-gyre-math for matched default math.}%
    }
  \fi\fi\fi\fi
\fi
\makeatother
...
%   methods:        CUNY Blue (#003DA5), used sparingly for top-level cues
...
% methods:     readable technical report margins
...
\doublespacing
$else$
  %% humanities: slightly more generous leading; methods: compact; docdesigner: balanced
  \ifdocdesignerhumanities
    \setstretch{1.55}
  \else\ifdocdesignermethods
    \setstretch{1.25}
...
% methods:    bold level-1 accent + rule below, black lower headings
...
$else$
  ...
  \else\ifdocdesignermethods
    ...
    \titleformat{\subsection}{\normalsize\bfseries}{}{0pt}{}
    \titleformat{\subsubsection}{\small\itshape}{}{0pt}{}
    \titlespacing{\section}{0pt}{1.75ex plus 0.5ex}{-0.5ex}
    \titlespacing{\subsection}{0pt}{1.25ex plus 0.25ex}{-0.5ex}
    \titlespacing{\subsubsection}{0pt}{1ex plus 0.25ex}{-0.5ex}
  \else\ifdocdesignerdocdesigner
...
$else$%
%% String author path: name + top-level author_* variables.
...
\newcommand{\docdesignercompacttitle}[1]{%
