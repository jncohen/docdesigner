...
\hypersetup{
  pdftitle    = {Fontset Test: docdesigner: Synthetic document for visual
regression checks},
...
\fancyhead[R]{\small\itshape Template: Fontset Test: docdesigner}
...
\begin{center}
\begin{singlespace}
{\setstretch{0.9}\LARGE\bfseries Fontset Test: docdesigner\par}
...
\begingroup
\setbox0=\hbox{\large\bfseries Fontset Test: docdesigner}%
\ifdim\wd0>\linewidth
  \noindent\resizebox{\linewidth}{!}{\large\bfseries Fontset Test:
docdesigner}\par
\else
  {\large\bfseries Fontset Test: docdesigner\par}%
\fi
\endgroup
...
\vspace{2.2em}
{\setstretch{0.92}\huge\scshape Fontset Test: docdesigner\par}
\vspace{0.35em}
...
{\setstretch{0.92}\LARGE\bfseries Fontset Test: docdesigner\par}
...
\pandocbounded{\includegraphics[keepaspectratio]{fontset-docdesigner_files/fontset-docdesigner_files/figure-latex/figure-example-1.pdf}}
