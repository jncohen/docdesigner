...
subtitle: "Standalone specimen — style: government"
author: |
  Joseph N. Cohen\
  *Meridian University*
...
<!--
Standalone rendering check for the "government" design-sets draft.
...
type family. A footnote hangs off this sentence,[^scale] so the footnote rule,
size and numbering can be judged in place.

[^scale]: Footnotes exercise `footnotes.size` and `footnotes.numbering`.
    A second line confirms the indent of a wrapped footnote.
...
: Median household net worth by quintile, 2022.
